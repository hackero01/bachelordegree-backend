...
namespace PortalStudenti.Repository
{
    public class Query
    {
        ...
        public static string loginCheck = @"SELECT [id_utilizator] ,[nume],[prenume],[email],[parola],[adresa],[nr_telefon],[conectat],r.[denumire] AS statut,r.[id_rol] 
        ...
        public static string updateAccount = @" UPDATE [dbo].[tbl_utilizatori] SET [nume]=@nume,[prenume]=@prenume,[email]=@email,[parola]=@parola,[adresa]=@adresa,[nr_telefon]=@nrTelefon WHERE [id_utilizator]=@id_utilizator";
